...
const conversationStates = {}; // In-memory per-user step tracking
var temp = 0;
...
function getIntentRegex(userInput) {
  ...
  if (
    ...
    return "Bonjour, je m’appelle nom, prénom et je suis étudiant-e infirmier-ère, actuellement en 1ère année Bachelor";
  }
  if (
...
async function getIntent(userInput, currentStep = 1) {
  ...
  const getRelevantIntents = (step) => {
    switch (step) {
      ...
      case 7:
        return ["Vous etes bien Madame Aubry, Denise, du 14.05.1940"]; // Reset-like behavior
      default:
        return ["unknown"];
    }
  };
    ...
    switch (currentStep) {  
      ...
      case 4:
        ...
        switch (intent) {
                ...
                if(temp == 3){
                    ...
                    media = {
                        imageUrl:
                          '',
                        caption:
                          'la patiente n arrive pas à répondre correctement à vos questions'
              ...
              case 'Avez-vous mal/des douleurs ?':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'+temp;
              ...
              break
              case 'Qu’est ce qui provoque votre douleur ?':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'+temp;
              ...
              break
              case 'Qu’est ce qui aide à soulager votre douleur ?':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              break
              case 'Depuis quand avez-vous mal/des douleurs ? ':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              break
              case 'Est-ce que votre douleur est continu ou disparait par moments ?':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              break
              case 'De quel problème croyez-vous qu’il s’agît ':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              case 'Avez-vous déjà eu cette douleur dans le passé ?':
                responseText =
                'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              case ' Quel est l’impact de cette douleur sur votre quotidien ? »':
               responseText =
                  'S il vous plait, dites à mon mari de venir, il faut appeler la police avant qu il fasse nuit'
              ...
              case 'auzreee':
                ...
                media = {
                  imageUrl:
                    'https://firebasestorage.googleapis.com/v0/b/pfpheds.appspot.com/o/img1_canape.png?alt=media&token=97461139-e9ea-4f08-8c89-6f4278d879e0',
                  caption: 'Patiente penchée en avant'
                }
                break

              default:
                responseText = 'Raaahhahah '
                break
            }
            break;
