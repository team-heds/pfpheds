      ...
      <div v-else class="p-4 max-w-7xl mx-auto">
            ...
            <div class="flex align-items-center gap-3">
              ...
              <div>
                ...
                <p class="text-600 m-0 mt-1">
                  Tableau de bord pour la gestion du système de gamification
                </p>
              </div>
            </div>
        ...
        <div class="grid mb-4">
          <div class="col-12 md:col-6 lg:col-3">
            <div
              class="surface-card p-4 border-round shadow-2 hover:shadow-4 transition-all transition-duration-300"
            >
              <div class="flex align-items-center gap-3">
                <div
                  class="flex align-items-center justify-content-center w-4rem h-4rem bg-orange-100 border-circle"
                >
          ...
          <div class="col-12 md:col-6 lg:col-3">
            ...
            >
              <div class="flex align-items-center gap-3">
                <div
                  class="flex align-items-center justify-content-center w-4rem h-4rem bg-purple-100 border-circle"
                >
          ...
          <div class="col-12 md:col-6 lg:col-3">
            ...
            >
              <div class="flex align-items-center gap-3">
                <div
                  class="flex align-items-center justify-content-center w-4rem h-4rem bg-red-100 border-circle"
                >
          ...
          <div class="col-12 md:col-6 lg:col-3">
            ...
            >
              <div class="flex align-items-center gap-3">
                <div
                  class="flex align-items-center justify-content-center w-4rem h-4rem bg-green-100 border-circle"
                >
          ...
          <div class="grid">
            ...
            <div class="col-12 md:col-6 lg:col-4">
              ...
              >
                ...
                <p class="text-600 text-sm m-0 mb-3 line-height-3">
                  Créer, modifier et supprimer des défis
                </p>
                <span class="text-primary font-medium text-sm"
                  >{{ stats.challenges?.active || 0 }} actifs</span
                >
              </div>
            </div>
            ...
            <div class="col-12 md:col-6 lg:col-4">
              ...
              >
                ...
                <p class="text-600 text-sm m-0 mb-3 line-height-3">
                  Attribuer des rôles et gérer les permissions
                </p>
                <span class="text-primary font-medium text-sm"
                  >{{ stats.users?.total || 0 }} utilisateurs</span
                >
              </div>
            </div>
            ...
            <div class="col-12 md:col-6 lg:col-4">
              ...
              >
                ...
                <p class="text-600 text-sm m-0 mb-3 line-height-3">
                  Points des maisons et statistiques
                </p>
            ...
            <div class="col-12 md:col-6 lg:col-4">
              ...
              >
                <div
                  class="flex align-items-center justify-content-center w-3rem h-3rem bg-indigo-100 border-circle mb-3"
                >
        ...
        <div class="surface-card p-4 border-round shadow-2">
          ...
          <div class="flex flex-column gap-3">
            ...
            >
              <div
                class="flex align-items-center justify-content-center w-2rem h-2rem bg-primary border-circle"
              >
