...
export const kpiConfigurations = {
  ...
  pfp: [
    ...
    },
    {
      ...
      breakdownKey: 'institutionsByCanton',
      showChart: true,
      chartType: 'doughnut',
      chartHeight: 250,
      animated: true,
  ...
  gamification: [
    ...
    },
    {
      ...
      subtitle: 'Avec une activité XP sur la période',
      icon: 'pi pi-users',
      color: '#3b82f6',
      dataKey: 'usersActive',
      showChart: true,
