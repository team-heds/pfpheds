...
<style scoped>
.form-field{grid-column:span 6;display:grid;align-content:start;gap:.45rem;min-width:0}.form-field--span-3{grid-column:span 3}.form-field--span-4{grid-column:span 4}.form-field--span-6{grid-column:span 6}.form-field--span-8{grid-column:span 8}.form-field--span-12{grid-column:1/-1}label{color:var(--text-color);font-size:.875rem;font-weight:600}label span,.form-field__error{color:var(--red-500,#dc2626)}.form-field__hint,.form-field__error{font-size:.8125rem;line-height:1.4}.form-field__hint{color:var(--text-color-secondary)}:deep(.p-inputtext),:deep(.p-dropdown),:deep(.p-multiselect),:deep(.p-calendar),:deep(textarea){width:100%}@media(max-width:48rem){.form-field,.form-field--span-3,.form-field--span-4,.form-field--span-6,.form-field--span-8{grid-column:span 12}}@media(max-width:40rem){.form-field,.form-field--span-3,.form-field--span-4,.form-field--span-6,.form-field--span-8,.form-field--span-12{grid-column:1}}
</style>
