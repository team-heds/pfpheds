      ...
      },
      {
        ...
        items: [
         ...
         // { label: 'Gestion Rôles par Filière', icon: 'pi pi-id-card', to: '/admin/role-management' },
          { label: 'Rôles Utilisateurs', icon: 'pi pi-user-edit', to: '/admin/manage-user-roles' }
        ]
      },
      {
    ...
    items: [
      ...
      // Secrétariat FP
      {
        ...
        items: [
          ...
          { label: 'Couverture des stages', icon: 'pi pi-chart-pie', to: '/admin/formation-pratique/secretariat/couverture-stages' },
