<template>
    <div class="votation-result-profil">
      ...
      <div v-if="hasData">
        ...
        <div
          v-for="(votationGroup, groupKey) in filteredVotationData"
          :key="groupKey"
          class="votation-group"
        >
          <!-- Itération sur chaque sous-groupe (ex. PFP1A) -->
          <div
            v-for="(subGroup, subKey) in votationGroup"
            :key="subKey"
            class="votation-subgroup"
          >
