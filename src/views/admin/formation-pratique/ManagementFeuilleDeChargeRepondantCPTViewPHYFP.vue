  ...
  <AdminLayout>
    <div class="p-4">
      <div class="breadcrumb-section mb-3">
        ...
        <span class="text-900 font-medium">Feuille de Charge CPT</span>
      </div>
      <div class="surface-card fp-dark p-4 border-round shadow-2">
        <div class="flex align-items-center gap-3 mb-4">
          <i class="pi pi-file text-primary text-4xl"></i>
          <div>
            <h1 class="text-3xl font-bold text-900 m-0">Management Feuille De Charge Répondant CPT</h1>
            <p class="text-600 m-0 mt-2">Gestion des feuilles de charge des répondants CPT</p>
          </div>
        </div>
      </div>
    </div>
